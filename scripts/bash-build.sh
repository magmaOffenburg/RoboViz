...
VIZCLASSPATH=$CLASSPATH:$JOGL/gluegen-rt.jar:$JOGL/jogl.all.jar:$JOGL/nativewindow.all.jar:$JOGL/newt.all.jar:../lib/jsgl.jar:../lib/commons-compress-1.5.jar:../lib/jna-platform-4.2.2.jar:../lib/jna-4.2.2.jar:../src/
...
cp ../lib/jna-platform-4.2.2.jar $BIN/lib/
cp ../lib/jna-4.2.2.jar $BIN/lib/
