...
import roboviz.jsgl.jogl.IndexBuffer;
import roboviz.jsgl.jogl.VertexBuffer;
import roboviz.jsgl.jogl.VertexBuffer.BufferUsage;
...
public class MeshRendererVBO implements MeshRenderer {
    ...
    public void init(GL gl, Mesh mesh) {
        ...
        for (int i = 0; i < indexBuffers.length; i++) {
            ...
            indexBuffers[i].setData(part.bufferData(gl.getGL2()), 
                    part.numIndices * indexSizeBytes);
        }
