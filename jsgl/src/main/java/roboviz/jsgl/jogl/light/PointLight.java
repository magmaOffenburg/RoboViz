...
package roboviz.jsgl.jogl.light;
...
public class PointLight extends Light {
   ...
   public void applyTo(GL2 gl, int light) {
      ...
      gl.glLightf(light, GLLightingFunc.GL_CONSTANT_ATTENUATION,
            constantAttenuation);
      gl.glLightf(light, GLLightingFunc.GL_LINEAR_ATTENUATION,
            linearAttenuation);
      gl.glLightf(light, GLLightingFunc.GL_QUADRATIC_ATTENUATION,
