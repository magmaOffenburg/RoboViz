...
package roboviz.jsgl.jogl.util.shader;
...
import roboviz.jsgl.jogl.Shader;
...
public class ShaderWidgetParser {
   ...
   public static class SWSlider extends ShaderWidget {
      ...
      public SWSlider(String name, String uName, float min, float max,
            float defaultValue) {
         this.add(new JLabel(name));
         this.uniformName = uName;
         final JSlider slider = new JSlider((int) (min * 10.0f),
               (int) (max * 10.0f));
            ...
            public void stateChanged(ChangeEvent e) {
               if (uVariable != null) {
                  ...
                  ((Uniform.Float) uVariable)
                        .setValue(slider.getValue() / 10.0f);
               }
            }
         });
         this.add(slider);
   ...
   private static SWCheckbox createCheckbox(UniformType uType, String uName,
         String widgetName) {
      System.out.println("new sw checkbox");
      return new SWCheckbox(widgetName, uName);
   }

   private static SWSlider createSlider(UniformType uType, String uName,
         String widgetName, String[] params) {
