...
package roboviz.jsgl.jogl.view;
 ...
 */
public class OrbitCamera extends Camera3D implements KeyListener,
    ...
    public OrbitCamera(Vec3f target, float distance, float yaw, float pitch,
    ...
    protected void updateView() {
        ...
        viewMatrix = translate.times(rotXY).times(
                Matrix.createTranslation(target.times(-1)));
