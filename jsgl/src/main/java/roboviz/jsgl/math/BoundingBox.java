...
public class BoundingBox implements Serializable {
    ...
    public BoundingBox(Vec3f min, Vec3f max) {
        ...
        // edges
        edges = new Line[] { new Line(corners[0], corners[1]),
    ...
    private boolean axisTestX2(float a, float b, float fa, float fb, Vec3f[] v,
            Vec3f boxHalfSize) {
        float min, max;
        float p0 = a * v[0].y - b * v[0].z;
    ...
    private boolean axisTestY02(float a, float b, float fa, float fb,
            Vec3f[] v, Vec3f boxHalfSize) {
        float min, max;
    ...
    private boolean axisTestY1(float a, float b, float fa, float fb, Vec3f[] v,
            Vec3f boxHalfSize) {
        float min, max;
        float p0 = -a * v[0].x + b * v[0].z;
    ...
    private boolean axisTestZ12(float a, float b, float fa, float fb,
            Vec3f[] v, Vec3f boxHalfSize) {
        float min, max;
    ...
    private boolean axisTestZ0(float a, float b, float fa, float fb, Vec3f[] v,
            Vec3f boxHalfSize) {
        float min, max;
    ...
    public Vec3f[] intersect(Ray r) {
        int[] faces = new int[] { 3, 2, 1, 0, 5, 1, 2, 6, 6, 2, 3, 7, 7, 3, 0,
                4, 4, 0, 1, 5, 4, 5, 6, 7, };
