...
package roboviz.jsgl.math.geom;
...
public class Icosahedron {
    ...
    private static final int[][] TRI_VERTS = { { 0, 1, 2 }, { 0, 2, 3 },
            { 0, 3, 4 }, { 0, 4, 5 }, { 0, 5, 1 }, { 1, 9, 2 }, { 2, 9, 10 },
            { 2, 10, 3 }, { 3, 10, 6 }, { 3, 6, 4 }, { 4, 6, 7 }, { 4, 7, 5 },
            { 5, 7, 8 }, { 5, 8, 1 }, { 1, 8, 9 }, { 11, 6, 10 },
            { 11, 10, 9 }, { 11, 9, 8 }, { 11, 8, 7 }, { 11, 7, 6 } };
    
    // indices for edges of each triangle face (20 faces total)
    private static final int[][] TRI_EDGES = { { 0, 1, 2 }, { 2, 3, 4 },
            { 4, 5, 6 }, { 6, 7, 8 }, { 8, 9, 0 }, { 10, 11, 1 },
            { 11, 12, 13 }, { 13, 14, 3 }, { 14, 15, 16 }, { 16, 17, 5 },
            { 17, 18, 19 }, { 19, 20, 7 }, { 20, 21, 22 }, { 22, 23, 9 },
            { 23, 24, 10 }, { 25, 15, 26 }, { 26, 12, 27 }, { 27, 24, 28 },
            { 28, 21, 29 }, { 29, 18, 25 }, };
    
    // indices for vertices of each edge (30 edges total)
    private static final int[][] EDGE_VERTS = { { 0, 1 }, { 1, 2 }, { 2, 0 },
            { 2, 3 }, { 3, 0 }, { 3, 4 }, { 4, 0 }, { 4, 5 }, { 5, 0 },
            { 5, 1 }, { 1, 9 }, { 9, 2 }, { 9, 10 }, { 10, 2 }, { 10, 3 },
            { 10, 6 }, { 6, 3 }, { 6, 4 }, { 6, 7 }, { 7, 4 }, { 7, 5 },
            { 7, 8 }, { 8, 5 }, { 8, 1 }, { 8, 9 }, { 11, 6 }, { 11, 10 },
            { 9, 11 }, { 8, 11 }, { 7, 11 } };
    ...
    public Icosahedron(float side) {
        ...
        verts = new float[][] { { 0, Z1, 0 }, { 0, Z2, R }, { Cx, Z2, Cy },
                { hs, Z2, -H }, { -hs, Z2, -H }, { -Cx, Z2, Cy },
                { 0, -Z2, -R }, { -Cx, -Z2, -Cy }, { -hs, -Z2, H },
